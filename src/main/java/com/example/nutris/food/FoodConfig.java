...
public class FoodConfig {
    ...
    CommandLineRunner commandLineRunner(FoodRepository foodRepository) {
        return args -> {
            Food apple = new Food(0L, "apple", 95F, 25F, 1F, 0F, 19F, 3F, 86F, 0F, 0F, 7F, 0F, 0F, 0F, 0F, 0F, 1F, "Cardiovascular disease, Type 2 diabetes, Weight management, Cancer", "digestive issues, sensitive teeth");
